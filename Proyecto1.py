...
class Experimento:
    ...
    def __str__(self):
        return (f"Nombre del Experimento: {self.nombre}\n"
                ...
                f"Ingrese el tipo de expeimento (Quimica, Biologia, Fisica:) {self.tipo_experimento}\n"
...
def mostrar_menu():
    print("\033[1;33m""===== Menú del Programa: ==== "'\033[0;m')
    print("1. Agregar un nuevo experimento")
    print("2. Ver todos los experimentos")
    print("\033[1;33m"+"=======MANEJO DE DATOS======="'\033[0;m')    
    ...
    print("\033[1;31m"+"==7. Salir del programa =="'\033[0;m')
  
    opcion = input("\033[1;32m"+"Elige una opción: "'\033[0;m')
    return opcion
